...
var Button = function (props) {
    ...
    }), 5), hovered = _c[0], handleTouchStart = _c[1], handleTouchMove = _c[2], handleTouchEnd = _c[3], handleTouchCancel = _c[4];
    return (react.createElement("button", __assign({}, restProps, { onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, onTouchCancel: handleTouchCancel, className: clsx('remax-button', className, (_a = {}, _a[hoverClassName || ''] = hovered, _a)), onClick: onTap })));
};
Button.defaultProps = {
    hoverStayTime: 400,
    hoverStartTime: 50,
